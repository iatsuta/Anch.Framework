...
public class CommonTestMethodRunner : XunitTestMethodRunnerBase<CommonTestMethodRunnerContext, IXunitTestMethod, IXunitTestCase>
{
    public static CommonTestMethodRunner Instance { get; } = new();

    protected override async ValueTask<RunSummary> RunTestCase(CommonTestMethodRunnerContext ctxt, IXunitTestCase testCase)
    {
        ...
        try
        {
            ...
            return await CommonRunnerHelper.RunXunitTestCase(
                testCase,
                ctxt.MessageBus,
        ...
        IServiceProvider? serviceProvider)
    {
        ...
        await using var ctxt = new CommonTestMethodRunnerContext(
            testMethod,
            testCases,
            explicitOption,
            messageBus,
