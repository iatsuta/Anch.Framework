...
public class AccessDeniedExceptionService(IIdentityInfoSource identityInfoSource) : IAccessDeniedExceptionService
{
    ...
    private object? TryGetId(object domainObject, Type domainObjectType)
    {
        ...
        return new Func<object, IIdentityInfo<object, object>, object?>(this.TryGetId).CreateGenericMethod(domainObjectType, identityInfo.IdentityType)
            .Invoke<object?>(this, domainObject, identityInfo);
    }

    private object? TryGetId<TDomainObject, TIdent>(TDomainObject domainObject, IIdentityInfo<TDomainObject, TIdent> identityInfo)
