...
using Anch.SecuritySystem.Builders.AccessorsBuilder;
using Anch.SecuritySystem.Builders.MaterializedBuilder;
...
public class SecuritySystemSetup : ISecuritySystemSetup, IServiceInitializer
{
    private readonly List<DomainSecurityServiceSetup> domainBuilders = [];
    ...
    private readonly List<Action<IIdentitySourceSetup>> identitySetupActions = [];

    private readonly List<Action<IVisualIdentitySourceSetup>> visualIdentitySetupActions = [];
    ...
    public ISecuritySystemSetup SetSecurityAdministratorRule(DomainSecurityRule.RoleBaseSecurityRule rule)
    {
    ...
    public ISecuritySystemSetup AddSecurityContext<TSecurityContext>(TypedSecurityIdentity identity,
        Action<ISecurityContextInfoSetup<TSecurityContext>>? setup = null)
        where TSecurityContext : class, ISecurityContext
    {
        var builder = new SecurityContextInfoSetup<TSecurityContext>(identity);
    ...
    public ISecuritySystemSetup AddDomainSecurity<TDomainObject>(Action<IDomainSecurityServiceSetup<TDomainObject>> setup)
    {
        var builder = new DomainSecurityServiceSetup<TDomainObject>();
    ...
    public ISecuritySystemSetup AddSecurityRule(DomainSecurityRule.SecurityRuleHeader header, DomainSecurityRule implementation)
    {
    ...
    public ISecuritySystemSetup AddSecurityOperation(SecurityOperation securityOperation, SecurityOperationInfo info)
    {
    ...
    public ISecuritySystemSetup AddPermissionSystem<TPermissionSystemFactory>()
    ...
    public ISecuritySystemSetup AddPermissionSystem(Func<IServiceProvider, IPermissionSystemFactory> getFactory)
    {
    ...
    public ISecuritySystemSetup AddPermissionSystem(Func<IServiceProxyFactory, IPermissionSystemFactory> getFactory)
    {
        this.registerActions.Add(sc => sc.AddScopedFrom(getFactory));
    ...
    public ISecuritySystemSetup AddRunAsValidator<TValidator>()
    ...
    public ISecuritySystemSetup AddExtensions(ISecuritySystemExtension extensions)
    {
    ...
    public ISecuritySystemSetup SetAccessDeniedExceptionService<TAccessDeniedExceptionService>()
        ...
        where TUser : class
    {
        ...
        var userSourceBuilder = new UserSourceSetup<TUser>();
    ...
    public ISecuritySystemSetup SetSecurityAccessorInfinityStorage<TStorage>()
    ...
    public ISecuritySystemSetup SetDefaultSecurityRuleCredential(SecurityRuleCredential securityRuleCredential)
    {
    ...
    public ISecuritySystemSetup SetClientDomainModeSecurityRuleSource<TClientDomainModeSecurityRuleSource>()
    ...
    public ISecuritySystemSetup AddClientSecurityRuleInfoSource<TClientSecurityRuleInfoSource>()
    ...
    public ISecuritySystemSetup AddClientSecurityRuleInfoSource(Type sourceType)
    {
    ...
    public ISecuritySystemSetup SetQueryableSource<TQueryableSource>()
    ...
    public ISecuritySystemSetup SetDefaultCurrentUser<TDefaultCurrentUser>()
    ...
    public ISecuritySystemSetup SetDefaultCancellationTokenSource<TDefaultCancellationTokenSource>()
        where TDefaultCancellationTokenSource : class, IDefaultCancellationTokenSource
    {
        this.registerActions.Add(sc => sc.ReplaceSingleton<IDefaultCancellationTokenSource, TDefaultCancellationTokenSource>());

        return this;
    }

    public ISecuritySystemSetup SetGenericRepository<TGenericRepository>()
    ...
    public void Initialize(IServiceCollection services)
    {
        ...
        {
            domainBuilder.Initialize(services);
    ...
    private IServiceCollection RegisterGeneralServices(IServiceCollection services)
    {
        return services
            ...
            .AddSingleton(typeof(ISecurityIdentityManager<>), typeof(SecurityIdentityManager<>))
            .AddSingleton(typeof(ISecurityIdentityConverter<>), typeof(SecurityIdentityConverter<>))
            .AddSingleton<IPrincipalDataSecurityIdentityManager, PrincipalDataSecurityIdentityManager>()
